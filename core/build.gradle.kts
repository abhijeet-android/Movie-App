import com.abhijeet.movielistsample.buildsrc.utils.getLocalProperty
...
android {
    buildTypes.forEach {
        ...
        it.buildConfigField(
            type = "String",
            name = "TMDB_API_KEY", value = com.abhijeet.movielistsample.buildsrc.utils.getLocalProperty(
                "TMDB_API_KEY",
                project
            )
        )
